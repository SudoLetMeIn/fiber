...
class Spec extends SpecBase {
  ...
  test(
    run(
      "{ def u(r) = { if ((r < 3)) (r + 5) else (u((r + (-1))) + (r + 5)) }; u(13) }"
    ),
    "150"
  )
  test(
    run(
      "{ def h(d, n, t) = { if ((n < 1)) (t + 1) else (x((n + (-2))) + (d + 5)) }; def x(i) = { if ((i < 1)) (i + 2) else (h((i + 5), (i + (-2)), (i + 4)) + (i + 5)) }; x(12) }"
    ),
    "95"
  )
  test(
    run(
      "{ def t(r, x) = { if ((x < 2)) (r + 4) else (q((r + 2), (x + (-1))) + (x + 2)) }; def k(j) = { if ((j < 3)) (j + 5) else (i((j + (-2))) + (j + 1)) }; def i(s) = { if ((s < 2)) (s + 3) else (l((s + (-2))) + (s + 5)) }; def l(o) = { if ((o < 1)) (o + 1) else (t((o + 1), (o + (-1))) + (o + 5)) }; def q(b, x) = { if ((x < 3)) (b + 3) else (k((x + (-1))) + (b + 2)) }; t(14, 11) }"
    ),
    "86"
  )
  test(
    run(
      "(6.isInstanceOf[Int], false.isInstanceOf[Int], (6, 26).isInstanceOf[Int], Nil.isInstanceOf[Int], (6 :: Nil).isInstanceOf[Int], ((s) => s).isInstanceOf[Int])"
    ),
    "(true, false, false, false, false, false)"
  )
  test(
    run(
      "(6.isInstanceOf[Boolean], false.isInstanceOf[Boolean], (6, 26).isInstanceOf[Boolean], Nil.isInstanceOf[Boolean], (6 :: Nil).isInstanceOf[Boolean], ((t) => t).isInstanceOf[Boolean])"
    ),
    "(false, true, false, false, false, false)"
  )
  test(
    run(
      "(6.isInstanceOf[Tuple], false.isInstanceOf[Tuple], (6, 26).isInstanceOf[Tuple], Nil.isInstanceOf[Tuple], (6 :: Nil).isInstanceOf[Tuple], ((c) => c).isInstanceOf[Tuple])"
    ),
    "(false, false, true, false, false, false)"
  )
  test(
    run(
      "(6.isInstanceOf[List], true.isInstanceOf[List], (6, 26).isInstanceOf[List], Nil.isInstanceOf[List], (6 :: Nil).isInstanceOf[List], ((s) => s).isInstanceOf[List])"
    ),
    "(false, false, false, true, true, false)"
  )
  test(
    run(
      "(6.isInstanceOf[Function], false.isInstanceOf[Function], (6, 26).isInstanceOf[Function], Nil.isInstanceOf[Function], (6 :: Nil).isInstanceOf[Function], ((e) => e).isInstanceOf[Function])"
    ),
    "(false, false, false, false, false, true)"
  )
  test(
    run(
      "(((z) => z)(6).isInstanceOf[Int], ((k) => k)(true).isInstanceOf[Int])"
    ),
    "(true, false)"
  )
